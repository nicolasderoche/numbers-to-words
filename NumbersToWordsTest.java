...
public class NumbersToWordsTest {
    ...
    public void test20to100() {
        ...
        Assert.assertEquals("seventy-five", n2w.convert(75)); // example in exercice description
    ...
    public void test101to1000() {
        ...
        Assert.assertEquals("two hundred forty-five", n2w.convert(245)); // example in exercice description
    ...
    public void testAbove1000() {
        Assert.assertEquals("one thousand two hundred thirty-four", n2w.convert(1234));
    ...
    public void testNegativeNumbers() {
        ...
        Assert.assertEquals("minus one million two hundred thirty-four thousand five hundred sixty-seven",
                n2w.convert(-1234567));
        Assert.assertEquals("two billion one hundred forty-seven million four hundred eighty-three thousand six hundred forty-six",
                n2w.convert(Integer.MAX_VALUE - 1)); // 2 147 483 646
                // 987654321
                // 2147483646
    }
    ...
    public void testTooLargeNumbers() {
        Assert.assertEquals("Number is too large!", n2w.convert(Integer.MAX_VALUE));
    }
}